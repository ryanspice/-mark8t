<script>
	import { storeFE } from './store.js'; import validate from 'validate.js';
	...
	function formValidate() {
		...
		var objVal = validate({ [$storeFE.formElements[fIndex].fId]: $storeFE.formElements[fIndex].fValue }, constraints);
		validationArray = '';
...
<textarea id={objAttributes.fId} bind:value={$storeFE.formElements[fIndex].fValue}></textarea>