...
export const _GOOGLE_MAP_API_URL_ = writable(0);
_GOOGLE_MAP_API_URL_.set('https://maps.googleapis.com/maps/api/js?key=AIzaSyC0kOfDvde7Opm7lox40LGhPst31sRCRys&libraries=places&callback=initMap');
