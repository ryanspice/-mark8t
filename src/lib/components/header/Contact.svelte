  ...
  <div class=''>
    ...
    <div class=''>
      <ul class={'top-bar-info '+align}>
        ...
        <li style={"order:"+order[0]+";"}>
          <ExternalLink href={"mailto:"+website.siteContactEmail} icon="email"
            label={desktop?website.siteContactEmail:''} alt="Send Email" />
        </li>
        {/if}
        {#if (enabledPhone)}
        <li style={"order:"+order[1]+";"}>
          <ExternalLink href={"tel:"+website.siteContactPhone} icon="phone" label={desktop?website.siteContactPhone:''}
            alt="Make a Call" />
        </li>
        {/if}
        {#if (enabledFacebook)}
        <li style={"order:"+order[2]+";"}>
          <ExternalLink href={"https://"+website.siteContactFacebook} icon="facebook" alt="Facebook"
    ...
    <div>
      <div class=' link'>
        ...
        <a href={"mailto:"+website.siteContactEmail} alt={"Sent mail to "+website.siteContactEmail}>

        <!-- reserve -->
        <button class=" mdc-button mdc-button--outlined smui-button--color-primary ">
          <div class=" mdc-button__ripple">
    </div>
    <span class="mdc-button__label hidden">{desktop?"BOOK AN EVENT/RESERVATION":"RESERVE"}</span>
    </button>
