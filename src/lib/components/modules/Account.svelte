...
<Accordion>
	<Panel bind:open={panelInfo} on:click={(e)=>{localStorage.setItem('--panel--panelInfo',panelInfo);}}>
		<Header>
		...
		<Content>
			...
			<Input label="Tenant ID" bind:value={account.localAccountId} disabled={true} />
		</Content>
	</Panel>
</Accordion>
<!-- CONTACT INFO -->
<Accordion>
	<Panel bind:open={panelContactInfo} on:click={(e)=>
		...
		<Content>
			<Input label="Phone" class="w-100" type="tel" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" maxlength="17"
				bind:value={website.siteContactPhone} input={unsavedChanges} />
			<Input label="Email" class="w-100" bind:value={website.siteContactEmail} input={unsavedChanges} />
			<Input label="Facebook" class="w-100" bind:value={website.siteContactFacebook} input={unsavedChanges} />
			<Input label="Instagram" class="w-100" bind:value={website.siteContactInstagram} input={unsavedChanges} />
		</Content>
	</Panel>
</Accordion>